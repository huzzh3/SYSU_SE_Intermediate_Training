...
public class Calculator {
	...
	public static void main(String[] args) {
		...
		final JTextField num1TextField = new JTextField(10);
		
		// Set the operatorLaebl
		final JLabel operatorLabel = new JLabel("+");
		operatorLabel.setHorizontalAlignment(SwingConstants.CENTER);
		
		// Set the num2TextField
		final JTextField num2TextField = new JTextField(10);
		...
		// Set the resultLabel
		final JLabel resultLabel = new JLabel("res");
