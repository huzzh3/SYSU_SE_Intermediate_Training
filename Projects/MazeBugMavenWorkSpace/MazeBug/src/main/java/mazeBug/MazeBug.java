...
public class MazeBug extends Bug {
	...
	public void move() {
		...
		try {
			...
			logger.warning("There're error while using random()");
		}
	...
	public void initialDirectionPrediction() {
		...
		if (endPointLocation != null && currentLocation != null) {
	 ...
	 */
	public void findMostLikelyLocation(ArrayList<Location> locs) throws NoSuchAlgorithmException {
		Location currentLocation = null;
		int      direction       = 0;
		int      total           = 0;
		int      randomNumber    = 0;
